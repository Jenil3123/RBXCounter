...
// Premium Light Theme Colors (if enabled)
...
// Custom Gradients & Glassmorphism Base Colors
val GlassmorphismBackground = Color(0x33FFFFFF)
val GlassmorphismBorder = Color(0x1AFFFFFF)
val PremiumGold = Color(0xFFFFD700)
val PremiumGradientStart = Color(0xFF4A00E0)
val PremiumGradientEnd = Color(0xFF8E2DE2)
